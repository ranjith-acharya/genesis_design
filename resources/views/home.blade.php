...
@section('js')
    ...
    <script type="text/javascript">
        const paginationOptions = {
            ...
            searchTerm: "",
            filers: null,
            url: '@if(Auth::user()->role === \App\Statics\Statics::USER_TYPE_ADMIN){{route('admin.get')}}@elseif(Auth::user()->role === \App\Statics\Statics::USER_TYPE_CUSTOMER){{route('project.get')}}@else{{route('engineer.project.get')}}@endif'
        };
