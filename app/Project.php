...
{
    protected $fillable = [
        'name', 'description', 'street_1', 'street_2', 'city', 'state', 'zip', 'country', 'project_type_id', 'customer_id', 'latitude', 'longitude', 'status', 'project_status', 'company_id', 'assigned_date', 
    ];
