...
//    Design Status Customer
    ...
    const DESIGN_STATUS_ENGINEER = [self::DESIGN_STATUS_ENGINEER_HOLD, self::DESIGN_STATUS_ENGINEER_COMPLETED, self::DESIGN_STATUS_ENGINEER_SUMBITTED, self::DESIGN_STATUS_ENGINEER_PROGRESS, self::DESIGN_STATUS_ENGINEER_NOT_ASSIGNED];
