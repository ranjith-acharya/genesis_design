...
//    Design Status Customer
    ...
    const DESIGN_STATUS_CUSTOMER = [self::DESIGN_STATUS_CUSTOMER_HOLD, self::DESIGN_STATUS_CUSTOMER_CHANGE_REQUEST, self::DESIGN_STATUS_CUSTOMER_COMPLETED, self::DESIGN_STATUS_CUSTOMER_RECEIVED, self::DESIGN_STATUS_CUSTOMER_PROGRESS, self::DESIGN_STATUS_CUSTOMER_REQUESTED,self::DESIGN_STATUS_CUSTOMER_ACCEPTED,self::DESIGN_STATUS_CUSTOMER_REJECTED];
...
//    Design Status Engineer
    ...
    const DESIGN_STATUS_ENGINEER = [self::DESIGN_STATUS_ENGINEER_HOLD, self::DESIGN_STATUS_ENGINEER_COMPLETED, self::DESIGN_STATUS_ENGINEER_SUMBITTED, self::DESIGN_STATUS_ENGINEER_PROGRESS, self::DESIGN_STATUS_ENGINEER_NOT_ASSIGNED, self::DESIGN_STATUS_ENGINEER_REQUESTED,self::DESIGN_STATUS_ENGINEER_ACCEPTED,self::DESIGN_STATUS_ENGINEER_REJECTED,self::DESIGN_STATUS_ENGINEER_CHANGE_REQUEST,self::DESIGN_STATUS_ENGINEER_ASSIGNED];
